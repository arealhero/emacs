...
;; NOTE(vlad): use list-colors-display
...
(define-key global-map "\ef" 'forward-word)
(define-key global-map "\eb" 'backward-word)
...
(dpefine-key global-map "" 'rotate-yank-pointer)
